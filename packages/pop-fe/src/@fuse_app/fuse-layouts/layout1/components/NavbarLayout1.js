...
import Logo from '@fuse_app/fuse-layouts/shared-components/Logo';
import NavbarFoldedToggleButton from '@fuse_app/fuse-layouts/shared-components/NavbarFoldedToggleButton';
import NavbarMobileToggleButton from '@fuse_app/fuse-layouts/shared-components/NavbarMobileToggleButton';
import Navigation from '@fuse_app/fuse-layouts/shared-components/Navigation';
import UserNavbarHeader from '@fuse_app/fuse-layouts/shared-components/UserNavbarHeader';
	...
	return (
		<div className={clsx('flex flex-col overflow-hidden h-full', classes.root, props.className)}>
			{props.navTopInfo && props.navTopInfo[0].logo_only ? 
				...
				<img 
					className="logo-icon" 
					src={props.navTopInfo[0].logo_url ? props.navTopInfo[0].logo_url : "assets/images/1x1_logo.png"} 
					alt="logo"
