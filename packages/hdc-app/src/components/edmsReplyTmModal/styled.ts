...
export const ModalInputBox = styled.div`
    ${(props: StyledProps) =>
        props.$boxType == "wide"
            ...
            : props.$boxType == "desc"
            ? `width: 100%; height: 12%; padding: 10px;`
            : props.$boxType == "box"
            ? `width: 40%; padding: 10px; height: 10%; justify-content: space-between;`
            : props.$boxType == "box; padding: 10px 2px 10px 5px;"
            ? `width: 100%; flex: 1;  `
            : `width: 100%; height: 10%; padding: 0px 10px;`};
...
export const DocBtn = styled.button`
    ${(props: StyledProps) =>
        props.$boxType == "receiver" ? `margin-right: 2%; ` : `transform: scale(0.9);`}
    width: 6%;
    display: flex;
    height: 45px;
    opacity: 0.6;
