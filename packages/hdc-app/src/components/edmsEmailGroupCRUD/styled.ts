...
export const DetailBlockParent = styled.div`
    flex: 2.4;
    display: flex;
    justify-content: center;
    align-items: center;
...
export const DetailBlock = styled.div`
    background-color: white;
    border: ${(props: StyledProps) => (props.$isMerge ? `none` : `1px solid grey`)};
    flex: ${(props: StyledProps) => (props.$flex ? props.$flex : "0.9")};
    display: flex;
    justify-content: start;
    flex-direction: column;
    height: 100%;
    margin: ${(props: StyledProps) => (props.$isMerge ? `0` : `0 5px`)};
`;
...
export const SubTitle = styled.div`
    ...
    align-items: center;
    margin: 0 auto;
    margin-top: ${(props: StyledProps) => (props.$margin ? props.$margin + "px" : "10px")};
    height: 40px;
