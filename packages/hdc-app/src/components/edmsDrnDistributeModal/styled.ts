...
export const ModalInputBox = styled.div`
    ...
    ${(props: StyledProps) =>
        props.$boxType == "wide"
            ...
            ? `width: 100%; height: 10%;`
            : props.$boxType == "box"
            ? `width: 100%; flex-direction: column; height: 60%;`
            : props.$boxType == "half-box"
            ? `width: 100%; flex-direction: column; height: 20%; align-items: flex-start;`
            : props.$boxType == "half"
...
export const ChipBlock = styled(Chip)`
    ${(props: StyledProps) => {
        return props.$selected ? `background-color : #FF9800` : ``;
    }};
    margin-right : 4px;
`;
