...
import { GetSignLine, SetSignLine, GetAddressbook, SetWorkDeploy } from "../../common/action";
import { reducerState } from "../../common";
import { ToastComponent } from "components";
import { TreeViewComp } from "..";
import Draggable from "react-draggable";
//
export type edmsDinDeployInfoProps = {
    style?: object;
...
interface FinaledmsDinDeployInfoProps extends edmsDinDeployInfoProps {}

export const EdmsDinDeployInfo: React.FunctionComponent<FinaledmsDinDeployInfoProps> = props => {
    ...
    useEffect(() => {
        if (workSelector.work_deploy) {
            let line = [];
            for (var l of workSelector.work_deploy) {
                let _obj: any = {};
                _obj.id = l.user_id;
    ...
    }, [workSelector.work_deploy, props.visible]);
