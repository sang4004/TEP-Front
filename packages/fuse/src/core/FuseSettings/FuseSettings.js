import FuseLayoutConfigs from '../../layouts/FuseLayoutConfigs';
...
import { updateUserSettings } from 'fuse_app/lib/auth/store/userSlice';
import { setDefaultSettings } from 'fuse_app/lib/store/fuse/settingsSlice';
